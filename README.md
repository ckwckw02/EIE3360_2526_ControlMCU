...
3. Open STM32CubeIDE 2.0 -> File -> Import -> General -> "Projects from Folder or Archive".
   ![IDE import step 1](IDE/1.png) ![IDE import step 2](IDE/2.png)
...
16. In STM32CubeProgrammer select "USB" and refresh ports. If port not found, repeat step 15.
    ![Select USB in CubeProgrammer](IDE/14.png)
17. When port is found press "Connect" and then "Download".
    ![Connect and download](IDE/15.png)
18. After download, press "Confirm" and disconnect.
    ![Confirm and disconnect](IDE/16.png)
...
[Patrick Leung](mailto:patrick2023.leung@connect.polyu.hk?subject=EIE3360%20Questions) for the image souese and testing.
